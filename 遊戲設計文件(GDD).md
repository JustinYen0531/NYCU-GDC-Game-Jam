...
### 過關與失敗條件
*   每一關都有**最低接待顧客數**要求，玩家必須在關卡結束前完成至少指定數量的入住與結帳流程，才能算作正式過關。
*   單純存活並不代表勝利；若接待數不足，即使沒有被鬼魂壓垮，也只能算失敗或低評價未通關。
*   另一個主要失敗條件是**醜三提前出局**：
    *   膽小女人撞鬼後變鬼並成功逃出旅館，累積一次醜一。
    *   大膽男人撞鬼後成功離開並完成通報，累積一次醜一。
    *   當醜一累積至**醜三**時，該局立即失敗，不需等時間結束。
*   因此本作的核心目標可以簡化為：**接待足夠的顧客，同時避免醜三提前出局。**
...
### 小鬼頭的完整規格
*   小鬼頭**不會支付任何房費**，因此他們的存在本身更偏向壓力來源，而不是收入來源。
*   若櫃檯接待逾時，小鬼頭不只是不付錢，還會**直接搶走玩家現有的金幣**。
*   小鬼頭在館內的移動最不穩定，會頻繁穿梭不同房間、走廊與公共區域，是最容易把局勢攪亂的顧客類型。
*   他們本身不會因看見鬼而變鬼或通報，但會透過**大聲尖叫**吸引其他顧客靠近，讓其他顧客更容易目擊鬼魂，形成連鎖反應。
*   雖然小鬼頭的入住時間較短，但因為高移動性、零收益、會偷錢、會製造連鎖恐慌，實際上屬於高干擾單位。

### 顧客解鎖節奏與樓層難度
*   三種顧客不會一開始全部出現，而是隨著主線進度逐步解鎖。
*   小鬼頭會在較後段樓層與關卡才加入，作為明顯提升場面混亂度的進階干擾來源。
